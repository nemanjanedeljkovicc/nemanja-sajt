...
function dodaj(){
    ime2.innerHTML=`<input type="text" name="ime" id="ime3" placeholder="Ime:Primer(Nemanja)" /><span class="span-forma">Ime mora početi velikim slovom</span>`;
    prezime2.innerHTML=`<input type="text" name="prezime" id="prezime" placeholder="Prezime:Primer(Nedeljković)" /><span class="span-forma2">Prezime mora početi velikim slovom</span>`;
